    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          color: isActive ? AColors.surfaceAlt : AColors.surfaceAlt.withOpacity(0.3),
          border: Border.all(
            color: isActive ? AColors.primary.withOpacity(0.5) : Colors.white10,
            width: 1.5,
          ),
          boxShadow: isActive ? [BoxShadow(color: AColors.primary.withOpacity(0.2), blurRadius: 15)] : [],
        ),
