  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return GestureDetector(
      onTap: () => Navigator.push(
        ...
        PageRouteBuilder(
          opaque: false,
          transitionDuration: const Duration(milliseconds: 500), // Speed is key for smoothness
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: AColors.surface.withOpacity(0.8),
            ...
            errorWidget: (_, __, ___) => Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [Colors.white12, Colors.white.withOpacity(0.05)],
