                      ...
                      itemBuilder: (_, i) {
                        ...
                        return Container(
                          ...
                          child: ListTile(
                              ...
                              child: Container(
                                ...
                                child: (p.coverUrl != null && p.coverUrl!.isNotEmpty)
                                  ? CachedNetworkImage(
                                      imageUrl: p.coverUrl!, 
                                      fit: BoxFit.cover,
                                      placeholder: (_, __) => const Center(child: SizedBox(width: 15, height: 15, child: CircularProgressIndicator(strokeWidth: 2, color: AColors.primary))),
                                    )
                                  : Icon(Icons.playlist_play_rounded, color: AColors.primary.withOpacity(0.5), size: 28),
                              ),
                            ),
                            title: Text(p.name,
                                style: GoogleFonts.outfit(
                            ...
                            subtitle: Text(
                                '${p.songs.length} Tracks • ${p.description ?? 'Personal Collection'}',
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis,
                                style: GoogleFonts.outfit(
                        ...
                        ).animate(delay: (i * 30).ms).fadeIn().slideY(begin: 0.1, end: 0);
                      },
                    ),
                  ),
          ),
